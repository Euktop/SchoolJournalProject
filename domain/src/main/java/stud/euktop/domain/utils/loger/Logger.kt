package stud.euktop.domain.utils.loger
...
var logger: Logger? = object:Logger{
    ...
    private fun log(logType: String, tag: String, event: String, message: String?, th: Throwable? = null) {
        val message = "$event -- $message"
        print("$logType:[$tag]: $event -- $message $")
    }
}

fun <T : Any> T.toSimpleTag() = this::class.java.simpleName