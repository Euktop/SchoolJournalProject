...
class TeacherLessonsAdapter(
...
) : ListAdapter<TeacherLessonItem, TeacherLessonsAdapter.ViewHolder>(DiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemTeacherLessonBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ViewHolder(private val binding: ItemTeacherLessonBinding) :
        ...
        fun bind(item: TeacherLessonItem) {
            ...
            binding.tvLessonTime.text = binding.root.context.getString(
    ...
    private class DiffCallback : DiffUtil.ItemCallback<TeacherLessonItem>() {
        override fun areItemsTheSame(old: TeacherLessonItem, new: TeacherLessonItem) =
            old.lessonId == new.lessonId

        override fun areContentsTheSame(old: TeacherLessonItem, new: TeacherLessonItem) = old == new
    }
}